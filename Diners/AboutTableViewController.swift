...
//  Diners
//
//  Created by Александра Гольде on 31/01/2017.
...
class AboutTableViewController: UITableViewController {
    ...
    let sectionHeaders = ["Social Networks", "Web Sites"]
    let sectionContent = [["Facebook", "Youtube"], ["swiftbook.ru", "forum.swiftbook.ru"]]
    let firstSectionLinks = ["https://www.facebook.com/swiftbook.ru/", "https://www.youtube.com/channel/UCXlCPCsB09ftBA5bQfiSWoQ/"]
